...
# <--------- import StreamTrainer, chunk_data, metrics, pipeline --------->
...
# <--------- StreamTrainer initialization and state --------->
...
# <--------- StreamTrainer internal state and logging --------->
...
# <--------- StreamTrainer summary statistics and __repr__ --------->
...
# <--------- StreamTrainer internal state and logging --------->
    ...
    def test_rolling_accuracy_slides(self):
        ...
        ra.update([0, 0, 0], [1, 1, 1]) 
        ra.update([1, 1, 1], [1, 1, 1])  
